...
const shippedCodeMap = join(__dirname, 'assets/cdd/code-map.yml');
if (existsSync(shippedCodeMap)) {
  rmSync(shippedCodeMap, { force: true });
  console.log('Removed assets/cdd/code-map.yml (runtime artifact, not shipped)');
}

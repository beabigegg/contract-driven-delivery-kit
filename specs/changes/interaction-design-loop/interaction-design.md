...
applicability-reason: "cdd-kit is a CLI / agent-orchestration tool (agent prompts, SKILL workflow docs, the applicability.py reader, and the CI gate contract). This change adds no screen, control, or user-facing state of its own to design -- it ships the mechanism other changes use to design theirs. Dogfooding note: this file itself proves the ADR 0011 skip path this change ships."
---

# Interaction Design: interaction-design-loop
